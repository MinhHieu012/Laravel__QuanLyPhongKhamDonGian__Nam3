...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <!-- <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
                <div class="dropdown" style="position: relative; left: 1385px">
                    <button class="btn btn-light dropdown-toggle" style="width: 150px; border: 2px solid black" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa-solid fa-user" style="margin-right: 7px"></i> Admin
                    </button>
                    <ul class="dropdown-Menu dropdown-Menu-light" style=":hover{background: gray}" aria-labelledby="dropdownMenu2">
