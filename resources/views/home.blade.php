...
<div class="banner">
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text" style="font-size: 18px">Bệnh nhân có thể đặt lịch khám mọi lúc, mọi nơi, trên đủ các nền tảng. Thay thế cho việc đến đăng ký trực tiếp, xếp hàng và chờ đợi</p>
        </div>
    </div>
    ...
    <div id="card2" class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text" style="font-size: 18px">Được thăm khám, tư vấn bởi bác sỹ có chuyên môn cao đảm bảo chất lượng cho khách hàng</p>
        </div>
    </div>
    ...
    <div id="card4" class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text">Luôn luôn đảm bảo về sự uy tín và chất lượng đối với khách hàng khi đến khám và tư vấn sức khỏe</p>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
                ...
                <p style="font-size: 20px; margin-left: 35px">Đặt lịch hẹn tư vấn với bác sĩ có chuyên môn chuyên nghành cao</p> <br>
                ...
                <p style="font-size: 20px; margin-left: 35px">Luôn luôn đảm bảo về sự uy tín và chất lượng đối với khách hàng khi đến khám và tư vấn sức khỏe</p>
            </div>

            <div class="col-sm-5">
                <img class="img-fluid" src="{{ URL::asset('image/banner2.jpg') }}" style="border-radius: 10px" alt="img">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-sm">
                <div id="card-dichvu1" class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 18px">Giá: 100.000đ (Gói tư vấn sức khỏe thông thường + 1 lần khám mắt, tai mũi họng)</p>
            ...
            <div class="col-sm">
                <div id="card-dichvu1" class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 18px">Giá: 200.000đ (Gói tư vấn sức khỏe chuyên sâu + 1 lần khám mắt, tai mũi họng)</p>
                        <a href="{{ URL::asset('/datlich') }}" class="btn btn-primary">Đặt lịch tại đây</a>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div id="card-dichvu1" class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 18px">Giá: 230.000đ (Gói tư vấn sức khỏe chuyên sâu + 1 lần khám mắt, tai mũi họng miễn phí)</p>
                        <a href="{{ URL::asset('/datlich') }}" class="btn btn-primary">Đặt lịch tại đây</a>
                    </div>
                </div>
            </div>
