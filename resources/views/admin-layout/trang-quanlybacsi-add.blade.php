    ...
    <div>
        ...
        <form action="{{ URL::asset('admin/quanlybacsi/add') }}" class="a1" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="passoword" name="password" placeholder="Nhập mật khẩu của bác sĩ" required>
                @error('password')
                ...
                <li style="color: red; font-size: 17px;padding-bottom: 5px;margin-top: 5px">Kí tự đặc biệt (@, !, ...)</li>
                </p>
                @enderror
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Họ và tên</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Nhập họ tên của bác sĩ" required>
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Số điện thoại</label>
                <input type="phone" class="form-control" id="phone" name="phone" placeholder="Nhập số điện thoại của bác sĩ" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address" name="address" placeholder="Nhập địa chỉ của bác sĩ" required>
            </div>
            <button type="submit" class=" btn btn-success" id="add" name="add"><i class="fa-regular fa-plus"></i>Thêm bác sĩ</button>
        </form>
    </div>
@endsection
</body>
