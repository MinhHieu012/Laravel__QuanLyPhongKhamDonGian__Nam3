...
@section('content')
    <div>
        ...
        @endif
        <form action="{{ URL::asset('user/changepassword') }}" style="position: relative; top: 60px; left: 600px; width: 500px;" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @error('password')
                <p style="color: red; font-size: 17px; margin-top: 10px; font-weight: 500">Mật khẩu phải có 10 kí tự bao gồm ít nhất:
                ...
                <li style="color: red; font-size: 17px; margin-top: 10px; font-weight: 500">Kí tự đặc biệt (@, !, ...)</li>
                </p>
                @enderror
            </div>
            ...
            <button type="submit" onclick="confirm('Bạn hãy chắc chắn muốn đổi mật khẩu?')" class=" btn btn-success" id="changepassword" name="changepassword">Đổi mật khẩu</button>
        </form>
    </div>
@endsection
</body>
