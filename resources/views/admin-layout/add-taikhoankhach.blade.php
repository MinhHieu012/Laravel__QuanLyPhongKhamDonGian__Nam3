...
@section('content2')
    <div>
        ...
        <button type="button" style="position: relative; right: -270px; top: 40px" class="btn btn-primary" onclick="window.location.href='{{URL::asset('admin/quanlykhachhang/')}}';">Quay lại</button>
        ...
        <form method="POST" class="a2">
            ...
            <div class="mb-3">
                ...
                <div class="text">
                    @error('username')
                    <li style="color: red; font-size: 17px; margin-top: 10px">Tên đăng nhập đã tồn tại! Hoặc yêu cầu tối thiểu 4 kí tự và tối đa 30 kí tự </li>
                    @enderror
                </div>
            </div>
